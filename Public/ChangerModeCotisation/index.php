...
<head>
    ...
    <title>Changer mode de cotisation</title>
</head>
 <?php
...
<body>
    ...
    <div class="dash-container row">
        <div id="sidebar" class="sidebar col-3 shadow">
            <div class="sidebars-links p-4 mt-1">
                ...
                <a title="Changer mode de cotisation" href="../ChangerModeCotisation/"
                    class="side-link text-decoration-none text-dark acti-hov rounded-3">
                    <div class="side-item p-3 rounded-3 mb-2 acti"><i class="fa-solid fa-pen mr-pc ft-2"></i><span
                            class="nope">Mode
        ...
        <div id="fonction" class="fonction col-9 mt-2">
            <div style="z-index: 2;" class="erreur-zone position-absolute"></div>
            <div class="container d-flex align-content-center flex-wrap module-container">
                <div class="d-flex flex-column shadow-sm p-3 rounded m-auto bg-white mdl w-100">
                    <ul>
                        <form id="submit-module" action="">
                            <div class="choix">
                                <li>
                                    <h4 class="lis mb-2">Sélectionner une récompense</h4>
                                    <div class="mb-3">
                                        <select class="form-select p-3" id="selectRecompense" required>
    ...
    <script src="../Js/moduleUpdate.js" defer></script>
