...
<body>
    ...
    <div class="dash-container row">
        <div id="sidebar" class="sidebar col-3 shadow">
            <div class="sidebars-links p-4 mt-3">
                <a title="Tableau de bord" href="../Dashboard/"
                    class="side-link text-decoration-none acti-hov rounded-3">
                    <div class="side-item p-3 rounded-3 mb-2 text-dark"><i
                            class="fas fa-tachometer-alt mr-pc ft-2"></i><span class="nope">Tableau de bord</span>
                    </div>
                </a>
                <a title="Mes cotisations" href="../MesCotisations/"
                    class="side-link text-decoration-none text-dark rounded-3 text-green acti-hov">
                    <div class="side-item p-3 rounded-3 mb-2 acti"><i class="fa-solid fa-wallet mr-pc ft-2"></i><span
                            class="nope">Mes
                ...
                <a title="Cotisation" href="../Cotisation/"
                    ...
                    <div class="side-item p-3 rounded-3 mb-2"><i class="fa-solid fa-exchange-alt mr-pc ft-2"></i><span
                            class="nope">Cotisation</span>
                    </div>
                </a>
                <a title="Méthodes de paiement" href="../MethodesDePaiement/"
                    class="side-link text-decoration-none text-dark acti-hov rounded3">
        ...
        <div class="fonction mt-2">
            <div class="container">
                <div class="cotisation-container bg-white shadow-sm rounded p-4">
                    <div class="history">
                        <h4>Historique de cotisation</h4> <br>
                        <table class="table table-hover table-sm">
                            <thead class="rounded-5">
                                <tr>
                                    <th class="bg-success" style="padding: 15px;" scope="col">ID</th>
                                    <th class="bg-success" style="padding: 15px;" scope="col">Date</th>
                                    <th class="bg-success" style="padding: 15px;" scope="col">Montant</th>
                                    <th class="bg-success" style="padding: 15px;" scope="col">Récompense</th>
                                    <th class="bg-success" style="padding: 15px;" scope="col">Methode de paiement</th>
                                </tr>
                            </thead>
                            <tbody class="tb_rec">
